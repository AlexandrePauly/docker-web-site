...
<footer>
    ...
    <div id ="mainFooter">
        ...
        <div id="mainFooter-right">
            ...
            <ul>
                <li><a href="about.php" title="Vers la page 'À propos'">À propos</a></li>
                <li><a href="contact.php" title="Vers la page de contact">Contact</a></li>
                <li><a href="q&a.php" title="Vers la FAQ">FAQ</a></li>
                <li><a href="legalNotices.php" title="Vers la page des Mentions légales">Mentions légales</a></li>
            </ul>
        </div>
    </div>
</footer>