...
<?php 
    ...
    if (isset($_SESSION['user'])){
        echo '<a href="basics/connexion.php" title="Déconnexion : ' . $_SESSION['user'] . '" class="icon"><i class="fa fa-sign-out" aria-hidden="true"></i></a>';
    ...
    //Sinon, l'icon apparant lui propose de se connecter
        ...
        echo '<a href="basics/connexion.php" title="Accès à votre compte" class="icon"><i class="fa fa-user-circle" aria-hidden="true"></i></a>';
